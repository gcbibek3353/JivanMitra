      ...
      <section className="mt-16 relative overflow-hidden">
        ...
        <div className="section-container flex flex-col items-center pt-16 md:pt-24 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mb-10">
            Every day, millions search for symptoms online but get generic, unreliable advice. JivanMitra is changing that—an AI-powered voice assistant that understands your health history and gives personalized guidance for symptoms, diet, and fitness. Real help. Just for you.
          </p>
          ...
          <div className='px-4 py-8 md:px-12 lg:px-20'>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              <div className="flex flex-col items-center text-center group relative p-6 rounded-2xl bg-white/10 backdrop-blur-md transition-all duration-300 border border-transparent hover:border-white/30 hover:shadow-lg">
                ...
                <h3 className="text-xl font-semibold mb-2"> Sign In & Set Up</h3>
                <p className="text-gray-600">Create your account and share a few basic health details to personalize your experience.</p>
              </div>
              ...
              <div className="flex flex-col items-center text-center group relative p-6 rounded-2xl bg-white/10 backdrop-blur-md transition-all duration-300 border border-transparent hover:border-white/30 hover:shadow-lg">
                ...
                <h3 className="text-xl font-semibold mb-2"> Consult with JivanMitra</h3>
                <p className="text-gray-600">Talk to your AI health companion about your symptoms, lifestyle, or fitness goals—just like you'd speak to a real doctor.</p>
              </div>
              ...
              <div className="flex flex-col items-center text-center group relative p-6 rounded-2xl bg-white/10 backdrop-blur-md transition-all duration-300 border border-transparent hover:border-white/30 hover:shadow-lg">
                ...
                <h3 className="text-xl font-semibold mb-2">Receive Your Personalized Report</h3>
                <p className="text-gray-600">Get smart insights, customized wellness plans, and downloadable reports tailored just for you.</p>
              </div>
            </div>
          </div>
